...
class House(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='category_house')
    ...
    aminities = MultiSelectField(choices=CHOICES_CONDITIONS, max_choices=13, max_length=500)
    bathroom_type = models.CharField(choices=CHOICES_BATHROOM, max_length=16)
